...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">E-SOS | Foto</asp:Content>
				...
				<div class="blog column c-2 clearfix">
					...
					<div class="box">
						...
						<div class="boxInfo examInfo">
							...
							<% foreach (var item in ViewBag.listFoto) { %>
							<a title="<%: item.dokumentasi_title %>" class="gHover" href="<%: Url.Content(item.dokumentasi_path) %>" rel="lightbox">
								<img class="imgBorder" src="<%: Url.Content(item.dokumentasi_path) %>" alt="<%: item.dokumentasi_title %>" style="width:102px;height:144px;">
							</a>
							<% } %>
