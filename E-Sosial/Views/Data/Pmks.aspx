...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">E-SOS | PMKS</asp:Content>
		...
		<div id="content" class="clearfix">
			<div class="wrapper" style="margin-left:0px;">
                ...
                <div class="column c-d1 clearfix">
					<!-- NEWS -->
					<h3>Penyandang Masalah Kesejahteraan Sosial Pemkot Bandung (PMKS)</h3><br>
					<% using (Html.BeginForm("Pmks", "Data", FormMethod.Post, null)) { %>
